...
!(function (a, b) {
  ...
  j.prototype = {
    ...
    _process_options: function (e) {
      ...
      if (
        (f.startDate !== -(1 / 0) && (f.startDate ? (f.startDate instanceof Date ? (f.startDate = this._local_to_utc(this._zero_time(f.startDate))) : (f.startDate = q.parseDate(f.startDate, h, f.language))) : (f.startDate = -(1 / 0))),
    ...
    updateNavArrows: function () {
      if (this._allow_update) {
        ...
        switch (this.viewMode) {
          case 0:
            this.o.startDate !== -(1 / 0) && b <= this.o.startDate.getUTCFullYear() && c <= this.o.startDate.getUTCMonth() ? this.picker.find(".prev").css({ visibility: "hidden" }) : this.picker.find(".prev").css({ visibility: "visible" }),
              this.o.endDate !== 1 / 0 && b >= this.o.endDate.getUTCFullYear() && c >= this.o.endDate.getUTCMonth() ? this.picker.find(".next").css({ visibility: "hidden" }) : this.picker.find(".next").css({ visibility: "visible" });
            break;
          case 1:
          case 2:
