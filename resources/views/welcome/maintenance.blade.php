                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <div class="home-wrapper">
                            ...
                            <h1 class="home-text text-uppercase text-custom">stockistcontrolling.com sedang dalam proses Maintenance</h1>
                            <p class="text-muted">Jika proses maintenance selesai, akan segera diinformasikan</p>
                        </div>
