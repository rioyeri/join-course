...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Login | Flash Academia</title>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ asset('assets/images/preloader.gif') }}">
    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="text-center">
                <div class="logo">
                    <h1 class="text-light"><a href="{{ route('getHome') }}"><span>Flash Academia</span></a></h1>
                </div>
                ...
                <div class="p-20">
                    <form class="form-horizontal m-t-20" action="{{route('Login')}}" method="POST">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Email/Phone Number" name="login_id">
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <p>Atau</p>
                    <a href="{{ route('google.redirect') }}" class="btn btn-primary w-md waves-light">Login melalui Google Account</a>
                </div>
            </div>
