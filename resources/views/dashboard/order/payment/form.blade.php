...
@endif
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="hidden" id="order_bill" value="@isset($current_order_bill){{ $current_order_bill }}@else{{ 0 }}@endisset">
            <input type="text" class="form-control" name="order_bill_formated" id="order_bill_formated" value="@isset($data->get_order->order_bill)Rp {{ number_format($data->get_order->order_bill,2,",",".") }}@else{{ 0 }}@endisset" readonly>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 col-sm-3 control-label">Payment Amount</label>
        <div class="col-sm-9">
            <input type="number" class="form-control" name="payment_amount" id="payment_amount" value="@isset($data->payment_amount){{ $data->payment_amount }}@else{{ 0 }}@endisset" min="0">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-9">
            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                    <img src="@isset($data->payment_evidence)dashboard/assets/payment/{{ substr($data->get_order->order_id,1) }}/{{ $data->payment_evidence }} @endisset" alt="" />
                </div>
