...
@section('content')
    ...
    <div class="content-panel">
        ...
        <div class="adv-table">
            <table width="100%" cellpadding="0" cellspacing="0" class="table table-bordered datatable dt-responsive wrap" id="table-content">
                <thead>
                    <th>No</th>
                    <th>Segment</th>
                    <th>Contents</th>
...
@section('js')
    ...
    <!-- Editable Table-->
    <script src="{{ asset('dashboard/additionalplugins/tiny-editable/mindmup-editabletable.js') }}"></script>
    <script src="{{ asset('dashboard/additionalplugins/tiny-editable/numeric-input-example.js') }}"></script>
...
<script type="text/javascript">
        ...
        $('#table-content').DataTable({
            ...
            "ajax" : {
                ...
                "data" : {
                    ...
                    {data : "segment", name : "segment", orderable : false},
    ...
    function change_status(id){
        ...
        swal({
            ...
            $.ajax({
                url : "/contentmanagement/"+id+"/changestatus",
                type : "post",
                dataType: 'json',
                data: {
                    "_token":token,
