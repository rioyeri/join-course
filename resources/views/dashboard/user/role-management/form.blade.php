...
@endif
    ...
    @else
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <select class="form-control select2" parsley-trigger="change" name="username" id="username">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <select class="form-control select2" parsley-trigger="change" name="role_id" id="role_id">
                <option value="#" selected disabled>-- Choose --</option>
